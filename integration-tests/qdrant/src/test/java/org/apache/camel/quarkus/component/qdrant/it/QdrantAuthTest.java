...
@QuarkusTestResource(QdrantAuthTestResource.class)
@QuarkusTest
class QdrantAuthTest {

    @Test
    void apiKeyAuthenticationShouldWork() {
        // Verify that ApiKeyCredentials can be used through Camel in native mode
        // This tests that ApiKeyCredentials is properly registered for reflection
