...
public class QdrantResource {
    ...
    public Response testWithValidApiKey() {
        // Test that API key authentication works through Camel
        // The component is already configured with correct API key in QdrantTestResource
        // This tests ApiKeyCredentials reflection in native mode
    ...
    public Response testWithInvalidApiKey() {
        ...
        try {
            ...
            if (exceptionChainContains(e, "UNAUTHENTICATED") || exceptionChainContains(e, "PERMISSION_DENIED")) {
                return Response.ok("Authentication correctly failed").build();
            }
            return Response.status(500)
