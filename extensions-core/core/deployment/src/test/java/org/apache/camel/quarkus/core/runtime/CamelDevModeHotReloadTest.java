...
/**
 * Test that verifies Camel route hot reload works correctly after the CamelHotReplacementSetup
 * fix for race conditions (issue #8318).
 */
public class CamelDevModeHotReloadTest {
    ...
    public void testRouteHotReload() {
        ...
        // Clear logs and modify the route
